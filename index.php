...
<html>
            ...
            [
  {
    ...
    "review": { 
        "reviewer" : "Jack", 
        "location" : "Florida", 
        "email" : { "username" : "jackfl", "host": "florida.com", "winner" : "true", "fullmail" : "jackfl@florida.com" }
    } 
  },
  {
   ...
   },
   {
      ...
      "Origin":"USA"
            ...
            function Lista( data )
            {
                ...
                {
                    var result = this.writeManagementBar() + 
        ...
        table.ListaElements th {
          background-image: linear-gradient(to right top, #c6c6c6, #cccbcc, #d3d1d2, #dad6d7, #e1dbdb);
                      text-transform: capitalize;
            cursor:grab/pointer;
        }

        table.ListaElements th:hover {
          background-image: linear-gradient(to right top, #c6c6c6, #d0d0d0, #dadada, #e4e4e4, #eeeeee);
        }
        ...
        .actionButton, .searchPlugin button {
          background-image: linear-gradient(to right top, #c6c6c6, #cccbcc, #d3d1d2, #dad6d7, #e1dbdb);
        ...
        .searchPlugin button:hover {
          background-image: linear-gradient(to right top, #c6c6c6, #d0d0d0, #dadada, #e4e4e4, #eeeeee);
          text-decoration:underline;
          color:blueviolet;
        }

        .searchPlugin button:active {
          background-image: linear-gradient(to right top, #999999, #cccbcc, #d3d1d2, #dad6d7, #e1dbdb);
        }
        ...
        ul.actionButtons, ul.pageIndexes, ul.groupOptions {
          display: inline-block;
          padding: 0;
          margin: 0;
        ...
        ul.actionButtons li, ul.groupOptions li {
          display: inline-block;
          padding: 0;
          margin: 0;
          list-style-type: none;
        ...
        .searchPlugin input[type=text]::placeholder {
          color: #ccc;
        }

        select.pageNumbers, select.actionButtons, ul.actionButtons select {
          padding:7px;
          margin-left:3px;
          border:1px solid #ccc;
          border-radius:3px;
