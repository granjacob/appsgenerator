<li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#templates-nav" data-bs-toggle="collapse" href="index.php?p=#">
      <i class="bi bi-menu-button-wide"></i><span>Snippet stores</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <ul id="templates-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
        <a href="index.php?p=snippets/add-snippet-store">
          <i class="bi bi-circle"></i><span>Add snippet store</span>
        </a>
      </li>
      <li>
